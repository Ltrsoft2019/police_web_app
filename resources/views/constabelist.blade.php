                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-description">
                                    <a href="{{ route('congendermale') }}" style="text-decoration: none; color: inherit;">
                                        <button type="submit" class="btn btn-outline-inverse-info btn-icon-text"
                                            id="nreportDropdown" >
                                            Male
                                        </button>
                                    </a>
                                    <a href="{{ route('congenderfemale') }}" style="text-decoration: none; color: inherit;">
                                        <button type="submit" class="btn btn-outline-inverse-info btn-icon-text"
                                            id="nreportDropdown" >
                                            Female
                                        </button>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            @foreach ($constabelist as $Dyspname)
                                            <tr>
                                                <td class="py-1">
