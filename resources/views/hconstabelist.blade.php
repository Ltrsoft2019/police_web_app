            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-lg-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Head Constable Table</h4>
                                <p class="card-description">
                                    <a href="{{ route('hconsgendermale') }}" style="text-decoration: none; color: inherit;">
                                        <button type="submit" class="btn btn-outline-inverse-info btn-icon-text"
                                            id="nreportDropdown">
                                            Male
                                        </button>
                                    </a>
                                    <a href="{{ route('hconsgenderfemale') }}"
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            @foreach ($hconstablelist as $Dyspname)
                                                <tr>
                                                    <td class="py-1">
