...
class pi extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pidash',compact('district','UnitName','VICTIM_COUNT','Accused_Count','Conviction_Count','Accused_ChargeSheeted_Count','RI','Complaint_Mode',"Beat_Name",'Village_Area_Name','yearlyCounts'
