(function($) {
	...
	// var yearlyCountsArray = <?php echo json_encode($yearlyCounts); ?>;
	var yearlyCountsvalue = Object.values(yearlyCounts);
	var totalMonthFIRCounts = Object.values(MonthFIRCounts);
	var totalMonthHeinousCounts = Object.values(MonthHeinousCounts);
	var totalMonthNonHeinousCounts = Object.values(MonthNonHeinousCounts);

	var totalArrestedCounts = Object.values(ArrestedCounts);
	var totalArrestedMaleCounts = Object.values(ArrestedMaleCounts);
	var totalArrestecFemaleCounts = Object.values(ArrestecFemaleCounts);


	$(function() {
		var salesDifferencedata = {
			labels: Object.keys(yearlyCounts),  //["2024","2023","2022","2021","2020", "2019", "2018", "2017", "2016"],
			datasets: [{
				label: 'FIR',
				data: yearlyCountsvalue,  //[22, 28, 18, 20, 12,13,33,45,67],
				backgroundColor: [
						'#8169f2',
						'#6a4df5',
						'#4f2def',
		...
		if ($("#salesDifference").length) {
			...
			var barChart = new Chart(barChartCanvas, {
				type: 'bar', // Set type to 'bar' for a vertical bar chart
		...
		var bestSellersData = {
			datasets: [{
				data: [DySP, PI, PSI, ASI, HConstable,Constable],
				backgroundColor: [
					'#ee5b5b',
					'#fcd53b',
					'#0bdbb8',
		...
		var revenueChartData = {
			...
			datasets: [{
				label: 'Total',
				data: totalMonthFIRCounts,//[45, 45, 70, 70, 50, 50, 70, 60, 65, 60, 55, 55],
				backgroundColor: [
						'#0ddbb9',
				],
				borderColor: [
			...
			},
			{
				label: 'Henious',
				borderDash: [3, 4],
				data: totalMonthHeinousCounts,//[35, 35, 60, 60, 40, 40, 60, 50, 55, 50, 45, 45],
				borderColor: [
						'#464dee',
				],
				borderWidth: 2,
			...
			{
				label: 'Non-Henious',
				data: totalMonthNonHeinousCounts,//[25, 25, 50, 50, 30, 30, 50, 40, 45, 40, 35, 35],
				borderColor: [
						'#ee5b5b',
				],
				borderWidth: 2,
		...
		var visitorsTodayData = {
			...
			datasets: [
				{
				label: 'Female',
				data: totalArrestecFemaleCounts,//[15, 25, 20, 18, 24, 20, 16, 20,24,43,13,56],
				backgroundColor: [
						'rgba(238, 91, 91, .9)',
				],
				borderColor: [
				...
				{
				label: 'Male',
				data: totalArrestedMaleCounts,//[20, 30, 25, 23, 29, 25, 21, 25,21,66,21,77],
				backgroundColor: [
						'rgba(70, 77, 238, 1)',
				],
				borderColor: [
				...
				{
				label: 'Total',
				data: totalArrestedCounts,//[25, 35, 30, 28, 33, 30, 26, 30,3,85,22,33],
				backgroundColor: [
						'rgba(81, 225, 195, .9)',
				],
				borderColor: [
